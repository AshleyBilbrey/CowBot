            ...
            if(args[3] != null) {
                if((args[2].toLowerCase() == "t") || (args[2].toLowerCase() == "tercero")) {
                    ...
                    if((args[3].toLowerCase() == "b") || (args[3].toLowerCase() == "breakfast")) {
                        if(menu.tercero_breakfast[1] != null) {
                    ...
                    if((args[3].toLowerCase() == "b") || (args[3].toLowerCase() == "breakfast")) {
                        if(menu.segundo_breakfast[1] != null) {
